...
WHERE t.title_id IN (SELECT sd.title_id
                     FROM salesdetail sd, salesdetail sd2
                     WHERE sd.stor_id <> sd2.stor_id
                     AND sd.title_id = sd2.title_id);
...
SELECT DISTINCT title_id, t.title
FROM titles t, titleauthor ta
WHERE t.title_id = ta.title_id
  AND t.title_id NOT IN (SELECT ta.title_id
                         FROM titleauthor ta
